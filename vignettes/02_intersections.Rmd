...
## Rows: 19,700
## Columns: 3
## $ comid    [3m[38;5;246m<dbl>[39m[23m 4289595, 4290057, 4287059, 4287061, 4292649, 4292651, 4287…
## $ areasqkm [3m[38;5;246m<dbl>[39m[23m 12.2707, 4.0614, 2.8056, 6.7867, 18.1573, 27.8620, 11.6930…
## $ geom     [3m[38;5;246m<MULTIPOLYGON [m]>[39m[23m MULTIPOLYGON (((1976295 290..., MULTIPOLYGON …
```

In total we have 19,700 aggregation units to summarize over the 366 time steps. Both zonal and intersectr are designed to precompute a weight grid. Therefore we time how long it takes to do this using each method:
...
## 97       12      109 00308371 0500000US12109 12109 St. Johns   06 1555793097
## 143      12      049 00295746 0500000US12049 12049    Hardee   06 1651867900
## 285      12      125 00306913 0500000US12125 12125     Union   06  630807237
## 398      12      005 00295738 0500000US12005 12005       Bay   06 1964402055
## 403      12      039 00306918 0500000US12039 12039   Gadsden   06 1337193228
## 404      12      073 00306916 0500000US12073 12073      Leon   06 1727171525
##        awater state_name state_abbr jurisdiction_type
## 9     6247257    Florida         FL             state
## 97  571962797    Florida         FL             state
## 143   1439673    Florida         FL             state
## 285  16049079    Florida         FL             state
## 398 711451660    Florida         FL             state
## 403  31687293    Florida         FL             state
## 404  90453994    Florida         FL             state
##                           geometry
## 9   MULTIPOLYGON (((-82.06 27.2...
## 97  MULTIPOLYGON (((-81.68 30.1...
## 143 MULTIPOLYGON (((-82.05 27.6...
## 285 MULTIPOLYGON (((-82.58 29.9...
## 398 MULTIPOLYGON (((-85.99 30.3...
## 403 MULTIPOLYGON (((-84.93 30.6...
## 404 MULTIPOLYGON (((-84.72 30.3...
