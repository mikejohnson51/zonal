...
## $ value      <dbl> 8, 13, 10, 4, 5, 9, 12, 14, 17, 1, 11, 4, 5, 8, 10, 1,…
## $ percentage <dbl> 0.1333440, 0.0012883, 0.0137853, 0.1660485, 0.6205781,…
```
...
```r
system.time({
  lc = execute_zonal_cat(r, geom = AOI, ID = "geoid", rcl = rcl)
})
```
...
## Rows: 7,103
## Columns: 3
## $ geoid      <chr> "27077", "27077", "27077", "27077", "27077", "27077", …
## $ value      <chr> "woody_savanna", "deciduous_broad", "grassland", "mixe…
## $ percentage <dbl> 0.355295, 0.095976, 0.045633, 0.141788, 0.015364, 0.25…
```
...
plot(filter(midwest, value == 'croplands')['percentage'], 
            main = "Croplands")
```
...
```r
plot(filter(midwest, value == 'urban')['percentage'], 
            main = "Urban")
```
